...
Original file is located at
    https://colab.research.google.com/drive/10eO2JX_UGcYLClwqa1gavyTMOoRxA8su
"""
...
class CNNClassifier(nn.Module):
    def __init__(self,
        ...
        for filter_l in filters_length:
            self.convs.append(
                nn.Conv1d(vector_size, self.filters_count, filter_l)
            )
...
if __name__ == "__main__":
    ...
    pad_sequences = PadSequences(
        pad_value=0,
        max_length=None,
        min_length=1 #max(filters_lenght) #max conv
    )
