{
  ...
  "metadata": {
    "colab": {
      ...
      "provenance": [],
      "collapsed_sections": [],
      "authorship_tag": "ABX9TyPkwzGQDl11O6L0Wv3n7wPn",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/emiliomrb/AprendizajeProfundo/blob/master/Copy_of_cnn_py.ipynb\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      "metadata": {
        ...
        "id": "0xlFerwCboAI",
        "outputId": "d0db03bd-77bd-4691-ee81-41b755614e90"
      },
      "source": [
        "!git clone https://github.com/emiliomrb/AprendizajeProfundo"
      ],
      "execution_count": 1,
      "outputs": [
        {
          "output_type": "stream",
          "text": [
            "Cloning into 'AprendizajeProfundo'...\n",
            "remote: Enumerating objects: 281, done.\u001b[K\n",
            "remote: Total 281 (delta 0), reused 0 (delta 0), pack-reused 281\u001b[K\n",
            "Receiving objects: 100% (281/281), 3.17 MiB | 22.72 MiB/s, done.\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "        self.convs = []\n",
        "        for filter in self.filters_lenght:\n",
        "            self.convs.append(\n",
        "                nn.Conv1d(vector_size, self.filters_count, filter)\n",
        "            )\n",
