{
  ...
  "metadata": {
    "colab": {
      ...
      "provenance": [],
      "collapsed_sections": [],
      "authorship_tag": "ABX9TyMqcNjDUZSdpo72P+kCl6Fo",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/emiliomrb/AprendizajeProfundo/blob/master/cnn_py.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
